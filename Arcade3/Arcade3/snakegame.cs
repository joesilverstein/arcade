...
namespace WindowsFormsApplication1
{
    public partial class snakegame : Form
    {
        ...
        //URL of sound files
        string backgroundsoundlocation = "./rainforest_ambience-GlorySunz-1938133500.mp3";
        string turnsoundlocation = "./fireballsound.mp3";
        string fruitsoundlocation = "./Mushroom_Sound_Effect.mp3";
